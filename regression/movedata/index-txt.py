    ...
    for time,seed in enumerate(seeds):
        ...
        for i,name, m in zip(range(100),models_str, models):
            ...
            if isinstance(model,StackingRegressor):
                ...
                test_pred = model.predict(x_test)
                mse_test = np.append(mse_test,recall_score(y_test, test_pred))
                mae_test = np.append(mae_test,precision_score(y_test, test_pred))
                r2_test = np.append(r2_test,accuracy_score(test_pred, y_test))
                matrix={
                    'val':{'mae':mae(y_vals, y_val_p_s), 'mse': mse(y_vals, y_val_p_s), 'r2':accuracy_score(y_vals, y_val_p_s)},
            ...
            print("f1:", f1_score(test_pred, y_test,average='binary'))
            print(f1_score(test_pred, y_test, average='macro'))  # 0.266666
            print(f1_score(test_pred, y_test, average='micro'))  # 0.3333333
            print(f1_score(test_pred, y_test, average='weighted'))
            print("0正样本")
            print("f1:", f1_score(test_pred, y_test, average='binary',pos_label=0))
            print(f1_score(test_pred, y_test, average='macro',pos_label=0))  # 0.266666
            print(f1_score(test_pred, y_test, average='micro',pos_label=0))  # 0.3333333
            print(f1_score(test_pred, y_test, average='weighted',pos_label=0))
