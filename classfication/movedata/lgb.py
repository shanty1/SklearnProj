...
if __name__ == '__main__':
    ...
    param = {'num_leaves': 100, 'num_trees': 300, 'objective': 'binary', 'metric': ['auc', 'binary_logloss']}
    num_round = 10
    # bstcv = lgb.cv(param, train0_data, num_round, nfold=10)
    bst = lgb.train(param, train_data, num_round, valid_sets=[train_data], early_stopping_rounds=10)
