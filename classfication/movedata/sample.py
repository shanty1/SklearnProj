...
def train(modelfile, seeds=[1],  datafilepath='',test_size=5, label_flag = '就业增长率'):
    ...
    for time,seed in enumerate(seeds):
        ...
        print('{:10s}{:10s}{:10s}{:10s}{:10s}{:10s}{:10s}'.format('正例','准确率', '精确率', '召回率', 'macro-f1', 'micro-f1', 'weighted-f1'))
        print('{:10s}{:10.4f}{:10.4f}{:10.4f}{:10.4f}{:10.4f}{:10.4f}'.format('就业',accuracy,precision,recall,macro_f1,micro_f1,weighted_f1))
        ...
        print('{:10s}{:10.4f}{:10.4f}{:10.4f}{:10.4f}{:10.4f}{:10.4f}'.format('未就业',accuracy, precision, recall, macro_f1 ,micro_f1,weighted_f1 ))
